...
def timecourse(sim):
    ...
    graph_labelname = ['control, 0nm', '0.156 nm', '0.625 nm', '2.5 nm', '10.0 nm']
    ...
    for i in range(6):
        ...
        if i==0:
            for j in range(5):
                ...
                plt.fill_between(sim.t,sim.pEGFR_au[:,j]-sd,sim.pEGFR_au[:,j]+sd,lw=0,alpha=0.1)
            ...
            for j in range(5):
                ...
                plt.fill_between(sim.t,sim.pErbB2_au[:,j]-sd,sim.pErbB2_au[:,j]+sd,lw=0,alpha=0.1)
            ...
            for j in range(5):
                ...
                plt.fill_between(sim.t,sim.pErbB3_au[:,j]-sd,sim.pErbB3_au[:,j]+sd,lw=0,alpha=0.1)
            ...
            for j in range(5):
                ...
                plt.fill_between(sim.t,sim.pERK_au[:,j]-sd,sim.pERK_au[:,j]+sd,lw=0,alpha=0.1)
            ...
            for j in range(5):
                ...
                plt.fill_between(sim.t,sim.pAKT_au[:,j]-sd,sim.pAKT_au[:,j]+sd,lw=0,alpha=0.1)
            ...
            for j in range(5):
                ...
                plt.fill_between(sim.t,sim.pS6_au[:,j]-sd,sim.pS6_au[:,j]+sd,lw=0,alpha=0.1)
