...
def f_params():
	...
	x[C.Cxcl15_act2] = 0 #test
	x[C.Cxcl15_act1] = 0 #test
	x[C.Cxcl15_inh3] = 0 #test
	x[C.Cxcl15_inh2] = 3.20e2
	x[C.Cxcl15_inh1] = 1.00e3
	x[C.Cxcl15_turn] = 3.28e-3
	x[C.Dusp5_act3] = 0 #test
	x[C.Dusp5_act2] = 0 #test
	x[C.Dusp5_act1] = 0 #test
